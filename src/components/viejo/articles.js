...
const Article = ({img, title, date, link}) => {
  return (
    <motion.li 
      ...
      viewport={{ once: true }}
      className='relative w-full p-4 py-6 my-4 ronded-xl flex items-center
...
const articles = () => {
  return (
    <>
      <Head>
        <title>MartinRubio | Articles Page</title>
        <meta name="description" content='any description' />
      </Head>
      <TransitionEffect />
      <main className='w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light'>
        <Layout className='pt-16'>
          <AnimatedText text="Words Can Change Thw World!" className='mb-16 lg:!text-7xl sm:mb-8 sm:!text-6xl xs:!text-4xl' />
